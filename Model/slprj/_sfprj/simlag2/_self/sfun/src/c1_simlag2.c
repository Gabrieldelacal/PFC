...
static const char * c1_debug_family_names[27] = { "Ixx", "Iyy", "Izz", "TauB",
  "Weta", "J", "CdE1", "CdE2", "CdE3", "CdEta", "nargin", "nargout", "f1", "f2",
  "f3", "f4", "II", "Phi", "Theta", "Psi", "dPhi", "dTheta", "dPsi", "A", "l",
  "b", "y" };
...
static void sf_c1_simlag2(SFc1_simlag2InstanceStruct *chartInstance)
{
  ...
  c1_y = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c1_f4 = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c1_f3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c1_f2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c1_f1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _sfTime_ = (real_T)ssGetT(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c1_f1, 0U);
  _SFD_DATA_RANGE_CHECK(*c1_f2, 1U);
  _SFD_DATA_RANGE_CHECK(*c1_f3, 2U);
  _SFD_DATA_RANGE_CHECK(*c1_f4, 3U);
...
static void c1_chartstep_c1_simlag2(SFc1_simlag2InstanceStruct *chartInstance)
{
  ...
  char_T c1_u[8];
  const mxArray *c1_ye_y = NULL;
  real_T c1_b_u;
  const mxArray *c1_af_y = NULL;
  real_T c1_c_u;
  ...
  c1_ve_b = (real_T *)ssGetInputPortSignal(chartInstance->S, 13);
  ...
  c1_df_y = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  c1_b_f4 = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c1_b_f3 = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c1_b_f2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c1_b_f1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 0U, chartInstance->c1_sfEvent);
  c1_hoistedGlobal = *c1_b_f1;
  c1_b_hoistedGlobal = *c1_b_f2;
  c1_c_hoistedGlobal = *c1_b_f3;
  c1_d_hoistedGlobal = *c1_b_f4;
  ...
  c1_l_hoistedGlobal = *c1_ve_b;
  c1_f1 = c1_hoistedGlobal;
  c1_f2 = c1_b_hoistedGlobal;
  c1_f3 = c1_c_hoistedGlobal;
  c1_f4 = c1_d_hoistedGlobal;
  ...
  sf_debug_symbol_scope_add_eml_importable(c1_J, 5U, c1_c_sf_marshallOut,
    c1_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_CdE1, 6U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_CdE2, 7U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(&c1_CdE3, 8U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c1_CdEta, 9U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_nargout, 11U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(&c1_f1, 12U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_f2, 13U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_f3, 14U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_f4, 15U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c1_II, 16U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Phi, 17U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Theta, 18U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Psi, 19U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_dPhi, 20U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_dTheta, 21U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_dPsi, 22U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c1_A, 23U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_l, 24U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_b, 25U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c1_y, 26U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c1_c_a = c1_b;
  c1_d_b = ((c1_f1 + c1_f3) - c1_f2) - c1_f4;
  ...
  for (c1_i8 = 0; c1_i8 < 3; c1_i8++) {
    ...
    for (c1_i10 = 0; c1_i10 < 3; c1_i10++) {
      c1_f_a[c1_i10 + c1_i7] = c1_Weta[c1_i9 + c1_i8];
      c1_i9 += 3;
    }
  ...
  for (c1_i11 = 0; c1_i11 < 3; c1_i11++) {
    ...
    for (c1_i13 = 0; c1_i13 < 3; c1_i13++) {
      c1_g_y[c1_i12 + c1_i11] = 0.0;
      c1_i14 = 0;
      for (c1_i15 = 0; c1_i15 < 3; c1_i15++) {
        c1_g_y[c1_i12 + c1_i11] += c1_f_a[c1_i14 + c1_i11] * c1_g_b[c1_i15 +
          c1_i12];
        c1_i14 += 3;
      }
  ...
  for (c1_i19 = 0; c1_i19 < 9; c1_i19++) {
    c1_f_a[c1_i19] = c1_J[c1_i19];
  }

  for (c1_i20 = 0; c1_i20 < 9; c1_i20++) {
    c1_J[c1_i20] = c1_f_a[c1_i20];
  }

  for (c1_i21 = 0; c1_i21 < 9; c1_i21++) {
    c1_f_a[c1_i21] = c1_J[c1_i21];
  }

  for (c1_i22 = 0; c1_i22 < 9; c1_i22++) {
    c1_J[c1_i22] = c1_f_a[c1_i22];
  }
  ...
  for (c1_i23 = 0; c1_i23 < 3; c1_i23++) {
    ...
    for (c1_i25 = 0; c1_i25 < 3; c1_i25++) {
      ...
      for (c1_i27 = 0; c1_i27 < 3; c1_i27++) {
        c1_J[c1_i24 + c1_i23] += c1_g_y[c1_i26 + c1_i23] * c1_g_b[c1_i27 +
          c1_i24];
        c1_i26 += 3;
      }
  ...
  c1_g_a = c1_Iyy;
  c1_h_b = c1_mpower(chartInstance, c1_dTheta);
  ...
  c1_h_a = c1_h_y;
  c1_j_b = c1_p_x;
  c1_j_y = c1_h_a * c1_j_b;
  c1_b_A = c1_j_y;
  c1_q_x = c1_b_A;
  c1_r_x = c1_q_x;
  c1_k_y = c1_r_x / 2.0;
  c1_i_a = c1_Izz;
  c1_k_b = c1_mpower(chartInstance, c1_dTheta);
  ...
  c1_k_a = c1_Ixx;
  c1_n_b = c1_dPsi;
  c1_p_y = c1_k_a * c1_n_b;
  c1_l_a = c1_p_y;
  c1_o_b = c1_dTheta;
  c1_q_y = c1_l_a * c1_o_b;
  c1_w_x = c1_Theta;
  c1_x_x = c1_w_x;
  ...
  c1_n_a = c1_Iyy;
  c1_q_b = c1_mpower(chartInstance, c1_dPsi);
  ...
  c1_o_a = c1_s_y;
  c1_s_b = c1_ab_x;
  c1_u_y = c1_o_a * c1_s_b;
  c1_bb_x = c1_Theta;
  c1_cb_x = c1_bb_x;
  c1_cb_x = muDoubleScalarCos(c1_cb_x);
  c1_p_a = c1_u_y;
  c1_t_b = c1_mpower(chartInstance, c1_cb_x);
  c1_v_y = c1_p_a * c1_t_b;
  c1_d_A = c1_v_y;
  c1_db_x = c1_d_A;
  c1_eb_x = c1_db_x;
  c1_w_y = c1_eb_x / 2.0;
  c1_q_a = c1_Izz;
  c1_u_b = c1_mpower(chartInstance, c1_dPsi);
  c1_x_y = c1_q_a * c1_u_b;
  c1_v_b = c1_Phi;
  c1_y_y = 2.0 * c1_v_b;
  c1_fb_x = c1_y_y;
  c1_gb_x = c1_fb_x;
  ...
  c1_r_a = c1_x_y;
  c1_w_b = c1_gb_x;
  c1_ab_y = c1_r_a * c1_w_b;
  c1_hb_x = c1_Theta;
  c1_ib_x = c1_hb_x;
  c1_ib_x = muDoubleScalarCos(c1_ib_x);
  c1_s_a = c1_ab_y;
  c1_x_b = c1_mpower(chartInstance, c1_ib_x);
  c1_bb_y = c1_s_a * c1_x_b;
  c1_e_A = c1_bb_y;
  c1_jb_x = c1_e_A;
  c1_kb_x = c1_jb_x;
  c1_cb_y = c1_kb_x / 2.0;
  c1_t_a = c1_Iyy;
  c1_y_b = c1_dPsi;
  c1_db_y = c1_t_a * c1_y_b;
  c1_u_a = c1_db_y;
  c1_ab_b = c1_dTheta;
  c1_eb_y = c1_u_a * c1_ab_b;
  c1_bb_b = c1_Phi;
  c1_fb_y = 2.0 * c1_bb_b;
  c1_lb_x = c1_fb_y;
  c1_mb_x = c1_lb_x;
  ...
  c1_v_a = c1_eb_y;
  c1_cb_b = c1_mb_x;
  c1_gb_y = c1_v_a * c1_cb_b;
  c1_nb_x = c1_Theta;
  c1_ob_x = c1_nb_x;
  c1_ob_x = muDoubleScalarCos(c1_ob_x);
  c1_w_a = c1_gb_y;
  c1_db_b = c1_ob_x;
  c1_hb_y = c1_w_a * c1_db_b;
  c1_x_a = c1_Izz;
  c1_eb_b = c1_dPsi;
  ...
  c1_ab_a = c1_jb_y;
  c1_hb_b = c1_qb_x;
  c1_lb_y = c1_ab_a * c1_hb_b;
  c1_rb_x = c1_Theta;
  c1_sb_x = c1_rb_x;
  c1_sb_x = muDoubleScalarCos(c1_sb_x);
  c1_bb_a = c1_lb_y;
  c1_ib_b = c1_sb_x;
  c1_mb_y = c1_bb_a * c1_ib_b;
  c1_CdE1 = (((((c1_k_y - c1_o_y) - c1_r_y) - c1_w_y) + c1_cb_y) - c1_hb_y) +
    c1_mb_y;
  ...
  c1_eb_a = c1_pb_y;
  c1_mb_b = c1_dTheta;
  c1_qb_y = c1_eb_a * c1_mb_b;
  c1_vb_x = c1_Phi;
  c1_wb_x = c1_vb_x;
  c1_wb_x = muDoubleScalarCos(c1_wb_x);
  c1_fb_a = c1_qb_y;
  c1_nb_b = c1_wb_x;
  c1_rb_y = c1_fb_a * c1_nb_b;
  c1_xb_x = c1_Phi;
  c1_yb_x = c1_xb_x;
  ...
  c1_hb_a = c1_tb_y;
  c1_qb_b = c1_dTheta;
  c1_ub_y = c1_hb_a * c1_qb_b;
  c1_ac_x = c1_Phi;
  c1_bc_x = c1_ac_x;
  c1_bc_x = muDoubleScalarCos(c1_bc_x);
  c1_ib_a = c1_ub_y;
  c1_rb_b = c1_bc_x;
  c1_vb_y = c1_ib_a * c1_rb_b;
  c1_cc_x = c1_Phi;
  c1_dc_x = c1_cc_x;
  ...
  c1_lb_a = c1_xb_y;
  c1_ub_b = c1_mpower(chartInstance, c1_fc_x);
  ...
  c1_ob_a = c1_bc_y;
  c1_xb_b = c1_mpower(chartInstance, c1_jc_x);
  ...
  c1_sb_a = c1_fc_y;
  c1_cc_b = c1_mpower(chartInstance, c1_pc_x);
  ...
  c1_vb_a = c1_ic_y;
  c1_fc_b = c1_mpower(chartInstance, c1_tc_x);
  c1_jc_y = c1_vb_a * c1_fc_b;
  c1_wb_a = c1_dPhi;
  c1_gc_b = (((((c1_ob_y - c1_sb_y) + c1_wb_y) + c1_ac_y) - c1_dc_y) - c1_gc_y)
    + c1_jc_y;
  c1_kc_y = c1_wb_a * c1_gc_b;
  c1_xb_a = c1_Ixx;
  c1_hc_b = c1_mpower(chartInstance, c1_dPsi);
  ...
  c1_bc_a = c1_Iyy;
  c1_kc_b = c1_mpower(chartInstance, c1_dPsi);
  ...
  c1_dc_a = c1_pc_y;
  c1_mc_b = c1_mpower(chartInstance, c1_cd_x);
  ...
  c1_fc_a = c1_Izz;
  c1_oc_b = c1_mpower(chartInstance, c1_dPsi);
  c1_sc_y = c1_fc_a * c1_oc_b;
  c1_fd_x = c1_Phi;
  c1_gd_x = c1_fd_x;
  c1_gd_x = muDoubleScalarCos(c1_gd_x);
  c1_gc_a = c1_sc_y;
  c1_pc_b = c1_mpower(chartInstance, c1_gd_x);
  ...
  c1_CdE2 = ((c1_kc_y - c1_nc_y) + c1_rc_y) + c1_vc_y;
  ...
  c1_mc_a = c1_yc_y;
  c1_vc_b = c1_mpower(chartInstance, c1_od_x);
  ...
  c1_pc_a = c1_cd_y;
  c1_yc_b = c1_mpower(chartInstance, c1_sd_x);
  ...
  c1_tc_a = c1_gd_y;
  c1_dd_b = c1_mpower(chartInstance, c1_yd_x);
  ...
  c1_wc_a = c1_jd_y;
  c1_gd_b = c1_mpower(chartInstance, c1_de_x);
  c1_kd_y = c1_wc_a * c1_gd_b;
  c1_hd_b = c1_Iyy;
  c1_ld_y = 2.0 * c1_hd_b;
  c1_xc_a = c1_ld_y;
  c1_id_b = c1_dPsi;
  c1_md_y = c1_xc_a * c1_id_b;
  c1_ee_x = c1_Phi;
  c1_fe_x = c1_ee_x;
  c1_fe_x = muDoubleScalarCos(c1_fe_x);
  c1_yc_a = c1_md_y;
  c1_jd_b = c1_fe_x;
  c1_nd_y = c1_yc_a * c1_jd_b;
  c1_ge_x = c1_Theta;
  c1_he_x = c1_ge_x;
  c1_he_x = muDoubleScalarCos(c1_he_x);
  c1_ad_a = c1_nd_y;
  c1_kd_b = c1_mpower(chartInstance, c1_he_x);
  ...
  c1_cd_a = c1_qd_y;
  c1_nd_b = c1_dPsi;
  c1_rd_y = c1_cd_a * c1_nd_b;
  c1_ke_x = c1_Phi;
  c1_le_x = c1_ke_x;
  c1_le_x = muDoubleScalarCos(c1_le_x);
  c1_dd_a = c1_rd_y;
  c1_od_b = c1_le_x;
  c1_sd_y = c1_dd_a * c1_od_b;
  c1_me_x = c1_Theta;
  c1_ne_x = c1_me_x;
  c1_ne_x = muDoubleScalarCos(c1_ne_x);
  c1_ed_a = c1_sd_y;
  c1_pd_b = c1_mpower(chartInstance, c1_ne_x);
  ...
  c1_gd_a = -c1_dPhi;
  c1_rd_b = (((((c1_xc_y - c1_bd_y) + c1_ed_y) + c1_hd_y) - c1_kd_y) - c1_pd_y)
    + c1_ud_y;
  c1_vd_y = c1_gd_a * c1_rd_b;
  c1_hd_a = c1_Iyy;
  c1_sd_b = c1_mpower(chartInstance, c1_dTheta);
  ...
  c1_ld_a = c1_Izz;
  c1_wd_b = c1_mpower(chartInstance, c1_dTheta);
  ...
  c1_pd_a = c1_fe_y;
  c1_ce_b = c1_dPsi;
  c1_ge_y = c1_pd_a * c1_ce_b;
  c1_qd_a = c1_ge_y;
  c1_de_b = c1_dTheta;
  c1_he_y = c1_qd_a * c1_de_b;
  c1_df_x = c1_Theta;
  c1_ef_x = c1_df_x;
  ...
  c1_td_a = c1_ke_y;
  c1_he_b = c1_dPsi;
  c1_le_y = c1_td_a * c1_he_b;
  c1_ud_a = c1_le_y;
  c1_ie_b = c1_dTheta;
  c1_me_y = c1_ud_a * c1_ie_b;
  c1_hf_x = c1_Phi;
  c1_if_x = c1_hf_x;
  c1_if_x = muDoubleScalarCos(c1_if_x);
  c1_vd_a = c1_me_y;
  c1_je_b = c1_mpower(chartInstance, c1_if_x);
  ...
  c1_yd_a = c1_qe_y;
  c1_ne_b = c1_dPsi;
  c1_re_y = c1_yd_a * c1_ne_b;
  c1_ae_a = c1_re_y;
  c1_oe_b = c1_dTheta;
  c1_se_y = c1_ae_a * c1_oe_b;
  c1_nf_x = c1_Theta;
  c1_of_x = c1_nf_x;
  ...
  c1_ce_a = c1_te_y;
  c1_qe_b = c1_mpower(chartInstance, c1_qf_x);
  ...
  c1_CdE3 = ((((c1_vd_y - c1_ae_y) + c1_ee_y) + c1_je_y) - c1_pe_y) - c1_ve_y;
  ...
  for (c1_i28 = 0; c1_i28 < 9; c1_i28++) {
    c1_f_a[c1_i28] = c1_J[c1_i28];
  }

  for (c1_i29 = 0; c1_i29 < 9; c1_i29++) {
    c1_ee_a[c1_i29] = c1_f_a[c1_i29];
  }

  c1_inv3x3(chartInstance, c1_ee_a, c1_g_y);
  for (c1_i30 = 0; c1_i30 < 9; c1_i30++) {
    c1_fe_a[c1_i30] = c1_f_a[c1_i30];
  }

  c1_n1x = c1_norm(chartInstance, c1_fe_a);
  for (c1_i31 = 0; c1_i31 < 9; c1_i31++) {
    c1_we_y[c1_i31] = c1_g_y[c1_i31];
  }

  c1_n1xinv = c1_norm(chartInstance, c1_we_y);
  c1_ge_a = c1_n1x;
  c1_se_b = c1_n1xinv;
  c1_xe_y = c1_ge_a * c1_se_b;
  c1_rc = 1.0 / c1_xe_y;
  guard1 = FALSE;
  guard2 = FALSE;
  if (c1_n1x == 0.0) {
    ...
    c1_tf_x = c1_rc;
    c1_te_b = muDoubleScalarIsNaN(c1_tf_x);
    guard3 = FALSE;
    if (c1_te_b) {
      guard3 = TRUE;
    } else {
    ...
    if (guard3 == TRUE) {
      ...
      c1_ye_y = NULL;
      sf_mex_assign(&c1_ye_y, sf_mex_create("y", c1_u, 10, 0U, 1U, 0U, 2, 1, 8),
                    FALSE);
      c1_b_u = 14.0;
      c1_af_y = NULL;
      sf_mex_assign(&c1_af_y, sf_mex_create("y", &c1_b_u, 0, 0U, 0U, 0U, 0),
                    FALSE);
      c1_c_u = 6.0;
      c1_bf_y = NULL;
      sf_mex_assign(&c1_bf_y, sf_mex_create("y", &c1_c_u, 0, 0U, 0U, 0U, 0),
                    FALSE);
      c1_d_u = c1_uf_x;
      c1_cf_y = NULL;
      sf_mex_assign(&c1_cf_y, sf_mex_create("y", &c1_d_u, 0, 0U, 0U, 0U, 0),
                    FALSE);
      c1_e_emlrt_marshallIn(chartInstance, sf_mex_call_debug("sprintf", 1U, 2U,
        14, sf_mex_call_debug("sprintf", 1U, 3U, 14, c1_ye_y, 14, c1_af_y, 14,
        c1_bf_y), 14, c1_cf_y), "sprintf", c1_str);
  ...
  for (c1_i34 = 0; c1_i34 < 3; c1_i34++) {
    c1_ue_b[c1_i34] = c1_TauB[c1_i34] - c1_CdEta[c1_i34];
  }
  ...
  for (c1_i41 = 0; c1_i41 < 3; c1_i41++) {
    ...
    for (c1_i43 = 0; c1_i43 < 3; c1_i43++) {
      c1_y[c1_i41] += c1_g_y[c1_i42 + c1_i41] * c1_ue_b[c1_i43];
      c1_i42 += 3;
    }
  }
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1529562177U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2975275596U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2339766701U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1288389414U);
}
...
mxArray *sf_c1_simlag2_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("VI2zbEQI1y5VZCwqmQ61O");
  ...
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,5580);
...

        {
          ...
          c1_f2 = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c1_f1 = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c1_f1);
          _SFD_SET_DATA_VALUE_PTR(1U, c1_f2);
          _SFD_SET_DATA_VALUE_PTR(2U, c1_f3);
          _SFD_SET_DATA_VALUE_PTR(3U, c1_f4);
...
static void mdlSetWorkWidths_c1_simlag2(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1908132702U));
  ssSetChecksum1(S,(4234873183U));
  ssSetChecksum2(S,(3016425118U));
  ssSetChecksum3(S,(4290914799U));
