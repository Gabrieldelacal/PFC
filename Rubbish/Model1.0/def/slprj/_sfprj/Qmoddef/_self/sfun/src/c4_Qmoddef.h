#ifndef __c4_Qmoddef_h__
#define __c4_Qmoddef_h__
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_Qmoddef;
  SimStruct *S;
...
extern void c4_Qmoddef_method_dispatcher(SimStruct *S, int_T method, void *data);
