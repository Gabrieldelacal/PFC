#ifndef __c5_Qmoddef_h__
#define __c5_Qmoddef_h__
...
typedef struct {
  ...
  uint8_T c5_is_active_c5_Qmoddef;
  SimStruct *S;
...
extern void c5_Qmoddef_method_dispatcher(SimStruct *S, int_T method, void *data);
