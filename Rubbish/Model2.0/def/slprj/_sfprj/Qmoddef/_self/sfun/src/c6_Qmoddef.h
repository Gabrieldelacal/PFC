#ifndef __c6_Qmoddef_h__
#define __c6_Qmoddef_h__
...
typedef struct {
  ...
  uint8_T c6_is_active_c6_Qmoddef;
  SimStruct *S;
...
extern void c6_Qmoddef_method_dispatcher(SimStruct *S, int_T method, void *data);
