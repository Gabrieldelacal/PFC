#ifndef __c3_Qmoddef_h__
#define __c3_Qmoddef_h__
...
typedef struct {
  ...
  uint8_T c3_is_active_c3_Qmoddef;
  SimStruct *S;
...
extern void c3_Qmoddef_method_dispatcher(SimStruct *S, int_T method, void *data);
