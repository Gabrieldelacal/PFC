...
static const char * c1_debug_family_names[22] = { "Ixx", "Iyy", "Izz", "TauB",
  "Weta", "J", "CdEta", "nargin", "nargout", "w", "II", "Phi", "Theta", "Psi",
  "dPhi", "dTheta", "dPsi", "A", "l", "b", "k", "y" };

/* Function Declarations */
static void initialize_c1_simlag(SFc1_simlagInstanceStruct *chartInstance);
static void initialize_params_c1_simlag(SFc1_simlagInstanceStruct *chartInstance);
static void enable_c1_simlag(SFc1_simlagInstanceStruct *chartInstance);
static void disable_c1_simlag(SFc1_simlagInstanceStruct *chartInstance);
static void c1_update_debugger_state_c1_simlag(SFc1_simlagInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c1_simlag(SFc1_simlagInstanceStruct
  *chartInstance);
static void set_sim_state_c1_simlag(SFc1_simlagInstanceStruct *chartInstance,
  const mxArray *c1_st);
static void finalize_c1_simlag(SFc1_simlagInstanceStruct *chartInstance);
static void sf_c1_simlag(SFc1_simlagInstanceStruct *chartInstance);
static void c1_chartstep_c1_simlag(SFc1_simlagInstanceStruct *chartInstance);
static void initSimStructsc1_simlag(SFc1_simlagInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c1_machineNumber, uint32_T
  c1_chartNumber);
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData);
static void c1_emlrt_marshallIn(SFc1_simlagInstanceStruct *chartInstance, const
  mxArray *c1_y, const char_T *c1_identifier, real_T c1_b_y[3]);
static void c1_b_emlrt_marshallIn(SFc1_simlagInstanceStruct *chartInstance,
...
static const mxArray *c1_c_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static real_T c1_c_emlrt_marshallIn(SFc1_simlagInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_b_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static const mxArray *c1_d_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static void c1_d_emlrt_marshallIn(SFc1_simlagInstanceStruct *chartInstance,
...
static real_T c1_mpower(SFc1_simlagInstanceStruct *chartInstance, real_T c1_a);
static void c1_eml_scalar_eg(SFc1_simlagInstanceStruct *chartInstance);
static void c1_inv3x3(SFc1_simlagInstanceStruct *chartInstance, real_T c1_x[9],
                      real_T c1_y[9]);
static real_T c1_norm(SFc1_simlagInstanceStruct *chartInstance, real_T c1_x[9]);
static void c1_eml_warning(SFc1_simlagInstanceStruct *chartInstance);
static void c1_b_eml_warning(SFc1_simlagInstanceStruct *chartInstance, char_T
  c1_varargin_2[14]);
static void c1_b_eml_scalar_eg(SFc1_simlagInstanceStruct *chartInstance);
static void c1_e_emlrt_marshallIn(SFc1_simlagInstanceStruct *chartInstance,
  const mxArray *c1_sprintf, const char_T *c1_identifier, char_T c1_y[14]);
static void c1_f_emlrt_marshallIn(SFc1_simlagInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, char_T c1_y[14]);
static const mxArray *c1_e_sf_marshallOut(void *chartInstanceVoid, void
  *c1_inData);
static int32_T c1_g_emlrt_marshallIn(SFc1_simlagInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void c1_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData);
static uint8_T c1_h_emlrt_marshallIn(SFc1_simlagInstanceStruct *chartInstance,
  const mxArray *c1_b_is_active_c1_simlag, const char_T *c1_identifier);
static uint8_T c1_i_emlrt_marshallIn(SFc1_simlagInstanceStruct *chartInstance,
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId);
static void init_dsm_address_info(SFc1_simlagInstanceStruct *chartInstance);
...
static void initialize_c1_simlag(SFc1_simlagInstanceStruct *chartInstance)
{
  ...
  chartInstance->c1_is_active_c1_simlag = 0U;
}
  ...
  *chartInstance)
{
  ...
  c1_hoistedGlobal = chartInstance->c1_is_active_c1_simlag;
  ...
  const mxArray *c1_st)
{
  ...
  chartInstance->c1_is_active_c1_simlag = c1_h_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c1_u, 1)), "is_active_c1_simlag");
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_simlag(chartInstance);
...
static void sf_c1_simlag(SFc1_simlagInstanceStruct *chartInstance)
{
  ...
  real_T (*c1_y)[3];
  real_T (*c1_w)[4];
  c1_k = (real_T *)ssGetInputPortSignal(chartInstance->S, 11);
  c1_b = (real_T *)ssGetInputPortSignal(chartInstance->S, 10);
  c1_l = (real_T *)ssGetInputPortSignal(chartInstance->S, 9);
  c1_A = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 8);
  c1_dPsi = (real_T *)ssGetInputPortSignal(chartInstance->S, 7);
  c1_dTheta = (real_T *)ssGetInputPortSignal(chartInstance->S, 6);
  c1_dPhi = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  c1_Psi = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c1_Theta = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c1_Phi = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c1_II = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  c1_y = (real_T (*)[3])ssGetOutputPortSignal(chartInstance->S, 1);
  ...
  for (c1_i4 = 0; c1_i4 < 3; c1_i4++) {
    _SFD_DATA_RANGE_CHECK((*c1_II)[c1_i4], 2U);
  }

  _SFD_DATA_RANGE_CHECK(*c1_Phi, 3U);
  _SFD_DATA_RANGE_CHECK(*c1_Theta, 4U);
  _SFD_DATA_RANGE_CHECK(*c1_Psi, 5U);
  _SFD_DATA_RANGE_CHECK(*c1_dPhi, 6U);
  _SFD_DATA_RANGE_CHECK(*c1_dTheta, 7U);
  _SFD_DATA_RANGE_CHECK(*c1_dPsi, 8U);
  for (c1_i5 = 0; c1_i5 < 3; c1_i5++) {
    _SFD_DATA_RANGE_CHECK((*c1_A)[c1_i5], 9U);
  }

  _SFD_DATA_RANGE_CHECK(*c1_l, 10U);
  _SFD_DATA_RANGE_CHECK(*c1_b, 11U);
  _SFD_DATA_RANGE_CHECK(*c1_k, 12U);
  chartInstance->c1_sfEvent = CALL_EVENT;
  c1_chartstep_c1_simlag(chartInstance);
...
static void c1_chartstep_c1_simlag(SFc1_simlagInstanceStruct *chartInstance)
{
  ...
  c1_b_k = (real_T *)ssGetInputPortSignal(chartInstance->S, 11);
  c1_xe_b = (real_T *)ssGetInputPortSignal(chartInstance->S, 10);
  c1_b_l = (real_T *)ssGetInputPortSignal(chartInstance->S, 9);
  c1_f_A = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 8);
  c1_b_dPsi = (real_T *)ssGetInputPortSignal(chartInstance->S, 7);
  c1_b_dTheta = (real_T *)ssGetInputPortSignal(chartInstance->S, 6);
  c1_b_dPhi = (real_T *)ssGetInputPortSignal(chartInstance->S, 5);
  c1_b_Psi = (real_T *)ssGetInputPortSignal(chartInstance->S, 4);
  c1_b_Theta = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c1_b_Phi = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c1_b_II = (real_T (*)[3])ssGetInputPortSignal(chartInstance->S, 1);
  ...
  c1_hoistedGlobal = *c1_b_Phi;
  c1_b_hoistedGlobal = *c1_b_Theta;
  c1_c_hoistedGlobal = *c1_b_Psi;
  c1_d_hoistedGlobal = *c1_b_dPhi;
  c1_e_hoistedGlobal = *c1_b_dTheta;
  c1_f_hoistedGlobal = *c1_b_dPsi;
  c1_g_hoistedGlobal = *c1_b_l;
  c1_h_hoistedGlobal = *c1_xe_b;
  c1_i_hoistedGlobal = *c1_b_k;
  for (c1_i6 = 0; c1_i6 < 4; c1_i6++) {
    c1_w[c1_i6] = (*c1_b_w)[c1_i6];
  }

  for (c1_i7 = 0; c1_i7 < 3; c1_i7++) {
    c1_II[c1_i7] = (*c1_b_II)[c1_i7];
  }

  c1_Phi = c1_hoistedGlobal;
  c1_Theta = c1_b_hoistedGlobal;
  c1_Psi = c1_c_hoistedGlobal;
  c1_dPhi = c1_d_hoistedGlobal;
  c1_dTheta = c1_e_hoistedGlobal;
  c1_dPsi = c1_f_hoistedGlobal;
  for (c1_i8 = 0; c1_i8 < 3; c1_i8++) {
    c1_A[c1_i8] = (*c1_f_A)[c1_i8];
  }

  c1_l = c1_g_hoistedGlobal;
  c1_b = c1_h_hoistedGlobal;
  c1_k = c1_i_hoistedGlobal;
  sf_debug_symbol_scope_push_eml(0U, 22U, 22U, c1_debug_family_names,
  ...
  sf_debug_symbol_scope_add_eml_importable(c1_TauB, 3U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c1_Weta, 4U, c1_d_sf_marshallOut,
    c1_c_sf_marshallIn);
  sf_debug_symbol_scope_add_eml_importable(c1_J, 5U, c1_d_sf_marshallOut,
    c1_c_sf_marshallIn);
  ...
  sf_debug_symbol_scope_add_eml_importable(&c1_nargout, 8U, c1_b_sf_marshallOut,
    c1_b_sf_marshallIn);
  sf_debug_symbol_scope_add_eml(c1_w, 9U, c1_c_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c1_II, 10U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Phi, 11U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Theta, 12U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_Psi, 13U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_dPhi, 14U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_dTheta, 15U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_dPsi, 16U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(c1_A, 17U, c1_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_l, 18U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_b, 19U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml(&c1_k, 20U, c1_b_sf_marshallOut);
  sf_debug_symbol_scope_add_eml_importable(c1_y, 21U, c1_sf_marshallOut,
    c1_sf_marshallIn);
  CV_EML_FCN(0, 0);
  ...
  c1_b_y = c1_a * c1_b_b;
  c1_b_a = c1_b_y;
  c1_c_b = c1_mpower(chartInstance, c1_w[3]) - c1_mpower(chartInstance, c1_w[1]);
  c1_c_y = c1_b_a * c1_c_b;
  c1_c_a = c1_l;
  c1_d_b = c1_k;
  c1_d_y = c1_c_a * c1_d_b;
  c1_d_a = c1_d_y;
  c1_e_b = c1_mpower(chartInstance, c1_w[2]) - c1_mpower(chartInstance, c1_w[0]);
  c1_e_y = c1_d_a * c1_e_b;
  c1_e_a = c1_b;
  c1_f_b = ((c1_mpower(chartInstance, c1_w[0]) + c1_mpower(chartInstance, c1_w[2]))
            - c1_mpower(chartInstance, c1_w[1])) - c1_mpower(chartInstance,
    c1_w[3]);
  ...
  for (c1_i10 = 0; c1_i10 < 3; c1_i10++) {
    ...
    for (c1_i12 = 0; c1_i12 < 3; c1_i12++) {
      c1_h_a[c1_i12 + c1_i9] = c1_Weta[c1_i11 + c1_i10];
      c1_i11 += 3;
    }
  ...
  for (c1_i13 = 0; c1_i13 < 3; c1_i13++) {
    ...
    for (c1_i15 = 0; c1_i15 < 3; c1_i15++) {
      c1_i_y[c1_i14 + c1_i13] = 0.0;
      c1_i16 = 0;
      for (c1_i17 = 0; c1_i17 < 3; c1_i17++) {
        c1_i_y[c1_i14 + c1_i13] += c1_h_a[c1_i16 + c1_i13] * c1_i_b[c1_i17 +
          c1_i14];
        c1_i16 += 3;
      }
  ...
  for (c1_i23 = 0; c1_i23 < 9; c1_i23++) {
    c1_h_a[c1_i23] = c1_J[c1_i23];
  }

  for (c1_i24 = 0; c1_i24 < 9; c1_i24++) {
    c1_J[c1_i24] = c1_h_a[c1_i24];
  }

  for (c1_i25 = 0; c1_i25 < 3; c1_i25++) {
    c1_i26 = 0;
    for (c1_i27 = 0; c1_i27 < 3; c1_i27++) {
      c1_J[c1_i26 + c1_i25] = 0.0;
      c1_i28 = 0;
      for (c1_i29 = 0; c1_i29 < 3; c1_i29++) {
        c1_J[c1_i26 + c1_i25] += c1_i_y[c1_i28 + c1_i25] * c1_i_b[c1_i29 +
          c1_i26];
        c1_i28 += 3;
      }
  ...
  if (c1_n1x == 0.0) {
    ...
    if (guard3 == TRUE) {
      ...
      for (c1_i35 = 0; c1_i35 < 14; c1_i35++) {
        c1_b_str[c1_i35] = c1_str[c1_i35];
      }
  ...
  for (c1_i36 = 0; c1_i36 < 3; c1_i36++) {
    c1_we_b[c1_i36] = c1_TauB[c1_i36] - c1_CdEta[c1_i36];
  }
  ...
  for (c1_i41 = 0; c1_i41 < 3; c1_i41++) {
    c1_C[c1_i41] = c1_y[c1_i41];
  }

  for (c1_i42 = 0; c1_i42 < 3; c1_i42++) {
    c1_y[c1_i42] = c1_C[c1_i42];
  }
  ...
  for (c1_i43 = 0; c1_i43 < 3; c1_i43++) {
    ...
    for (c1_i45 = 0; c1_i45 < 3; c1_i45++) {
      c1_y[c1_i43] += c1_i_y[c1_i44 + c1_i43] * c1_we_b[c1_i45];
      c1_i44 += 3;
    }
  }
...
static const mxArray *c1_sf_marshallOut(void *chartInstanceVoid, void *c1_inData)
{
  ...
  real_T c1_u[3];
  const mxArray *c1_y = NULL;
  SFc1_simlagInstanceStruct *chartInstance;
  chartInstance = (SFc1_simlagInstanceStruct *)chartInstanceVoid;
  c1_mxArrayOutData = NULL;
  for (c1_i47 = 0; c1_i47 < 3; c1_i47++) {
    c1_b_inData[c1_i47] = (*(real_T (*)[3])c1_inData)[c1_i47];
  }
  ...
  *c1_mxArrayInData, const char_T *c1_varName, void *c1_outData)
{
  ...
  for (c1_i50 = 0; c1_i50 < 3; c1_i50++) {
    (*(real_T (*)[3])c1_outData)[c1_i50] = c1_b_y[c1_i50];
  }
  ...
  *c1_inData)
{
  ...
  for (c1_i51 = 0; c1_i51 < 4; c1_i51++) {
    c1_b_inData[c1_i51] = (*(real_T (*)[4])c1_inData)[c1_i51];
  }
  ...
  *c1_inData)
{
  ...
  for (c1_i54 = 0; c1_i54 < 3; c1_i54++) {
    for (c1_i55 = 0; c1_i55 < 3; c1_i55++) {
      c1_b_inData[c1_i55 + c1_i53] = (*(real_T (*)[9])c1_inData)[c1_i55 + c1_i53];
    }
  ...
  for (c1_i57 = 0; c1_i57 < 3; c1_i57++) {
    for (c1_i58 = 0; c1_i58 < 3; c1_i58++) {
      c1_u[c1_i58 + c1_i56] = c1_b_inData[c1_i58 + c1_i56];
    }
...
const mxArray *sf_c1_simlag_get_eml_resolved_functions_info(void)
{
  ...
  for (c1_i63 = 0; c1_i63 < 42; c1_i63++) {
    c1_r0 = &c1_info[c1_i63];
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", c1_r0->context, 15,
      0U, 0U, 0U, 2, 1, strlen(c1_r0->context)), "context", "nameCaptureInfo",
                    c1_i63);
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", c1_r0->name, 15, 0U,
      0U, 0U, 2, 1, strlen(c1_r0->name)), "name", "nameCaptureInfo", c1_i63);
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", c1_r0->dominantType,
      15, 0U, 0U, 0U, 2, 1, strlen(c1_r0->dominantType)), "dominantType",
                    "nameCaptureInfo", c1_i63);
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", c1_r0->resolved, 15,
      0U, 0U, 0U, 2, 1, strlen(c1_r0->resolved)), "resolved", "nameCaptureInfo",
                    c1_i63);
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", &c1_r0->fileTimeLo,
      7, 0U, 0U, 0U, 0), "fileTimeLo", "nameCaptureInfo", c1_i63);
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", &c1_r0->fileTimeHi,
      7, 0U, 0U, 0U, 0), "fileTimeHi", "nameCaptureInfo", c1_i63);
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", &c1_r0->mFileTimeLo,
      7, 0U, 0U, 0U, 0), "mFileTimeLo", "nameCaptureInfo", c1_i63);
    sf_mex_addfield(c1_m0, sf_mex_create("nameCaptureInfo", &c1_r0->mFileTimeHi,
      7, 0U, 0U, 0U, 0), "mFileTimeHi", "nameCaptureInfo", c1_i63);
  }
...
static void c1_info_helper(c1_ResolvedFunctionInfo c1_info[42])
{
  ...
  c1_info[8].fileTimeLo = 1286818706U;
  c1_info[8].fileTimeHi = 0U;
  c1_info[8].mFileTimeLo = 0U;
  c1_info[8].mFileTimeHi = 0U;
  c1_info[9].context =
    "[ILXE]/usr/local/matlab/toolbox/eml/lib/matlab/elfun/cos.m";
  c1_info[9].name = "eml_scalar_cos";
  c1_info[9].dominantType = "double";
  c1_info[9].resolved =
    "[ILXE]/usr/local/matlab/toolbox/eml/lib/matlab/elfun/eml_scalar_cos.m";
  c1_info[9].fileTimeLo = 1286818722U;
  ...
  c1_varargin_2[14])
{
  ...
  for (c1_i66 = 0; c1_i66 < 14; c1_i66++) {
    c1_b_u[c1_i66] = c1_varargin_2[c1_i66];
  }
  ...
  const mxArray *c1_u, const emlrtMsgIdentifier *c1_parentId, char_T c1_y[14])
{
  ...
  sf_mex_import(c1_parentId, sf_mex_dup(c1_u), c1_cv1, 1, 10, 0U, 1, 0U, 2, 1,
                14);
  for (c1_i67 = 0; c1_i67 < 14; c1_i67++) {
    c1_y[c1_i67] = c1_cv1[c1_i67];
  }
  ...
  const mxArray *c1_b_is_active_c1_simlag, const char_T *c1_identifier)
{
  ...
  c1_y = c1_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c1_b_is_active_c1_simlag), &c1_thisId);
  sf_mex_destroy(&c1_b_is_active_c1_simlag);
  return c1_y;
}
...
/* SFunction Glue Code */
void sf_c1_simlag_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(993977U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1282395877U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2180170075U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2817180687U);
}

mxArray *sf_c1_simlag_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("wGpz5bHyv7dnt2KcVaWSXB");
...
static const mxArray *sf_get_sim_state_info_c1_simlag(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"y\",},{M[8],M[0],T\"is_active_c1_simlag\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c1_simlag_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc1_simlagInstanceStruct *chartInstance;
    chartInstance = (SFc1_simlagInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,1,1,0,"II");
          _SFD_SET_DATA_PROPS(3,1,1,0,"Phi");
          _SFD_SET_DATA_PROPS(4,1,1,0,"Theta");
          _SFD_SET_DATA_PROPS(5,1,1,0,"Psi");
          _SFD_SET_DATA_PROPS(6,1,1,0,"dPhi");
          _SFD_SET_DATA_PROPS(7,1,1,0,"dTheta");
          _SFD_SET_DATA_PROPS(8,1,1,0,"dPsi");
          _SFD_SET_DATA_PROPS(9,1,1,0,"A");
          _SFD_SET_DATA_PROPS(10,1,1,0,"l");
          _SFD_SET_DATA_PROPS(11,1,1,0,"b");
          _SFD_SET_DATA_PROPS(12,1,1,0,"k");
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,4276);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(2U, *c1_II);
          _SFD_SET_DATA_VALUE_PTR(3U, c1_Phi);
          _SFD_SET_DATA_VALUE_PTR(4U, c1_Theta);
          _SFD_SET_DATA_VALUE_PTR(5U, c1_Psi);
          _SFD_SET_DATA_VALUE_PTR(6U, c1_dPhi);
          _SFD_SET_DATA_VALUE_PTR(7U, c1_dTheta);
          _SFD_SET_DATA_VALUE_PTR(8U, c1_dPsi);
          _SFD_SET_DATA_VALUE_PTR(9U, *c1_A);
          _SFD_SET_DATA_VALUE_PTR(10U, c1_l);
          _SFD_SET_DATA_VALUE_PTR(11U, c1_b);
          _SFD_SET_DATA_VALUE_PTR(12U, c1_k);
        }
      }
    } else {
...
{
  return "KPSCl1LnzhMLHNQ9Gpd58B";
}

static void sf_opaque_initialize_c1_simlag(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc1_simlagInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c1_simlag((SFc1_simlagInstanceStruct*) chartInstanceVar);
  initialize_c1_simlag((SFc1_simlagInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c1_simlag(void *chartInstanceVar)
{
  enable_c1_simlag((SFc1_simlagInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c1_simlag(void *chartInstanceVar)
{
  disable_c1_simlag((SFc1_simlagInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c1_simlag(void *chartInstanceVar)
{
  sf_c1_simlag((SFc1_simlagInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c1_simlag(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c1_simlag((SFc1_simlagInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c1_simlag();/* state var info */
...
extern void sf_internal_set_sim_state_c1_simlag(SimStruct* S, const mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c1_simlag((SFc1_simlagInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c1_simlag(SimStruct* S)
{
  return sf_internal_get_sim_state_c1_simlag(S);
}

static void sf_opaque_set_sim_state_c1_simlag(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c1_simlag(S, st);
}

static void sf_opaque_terminate_c1_simlag(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc1_simlagInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c1_simlag((SFc1_simlagInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc1_simlag((SFc1_simlagInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_simlag(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    initialize_params_c1_simlag((SFc1_simlagInstanceStruct*)(((ChartInfoStruct *)
      ssGetUserData(S))->chartInstance));
  }
}

static void mdlSetWorkWidths_c1_simlag(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(2452974217U));
  ssSetChecksum1(S,(1271160010U));
  ssSetChecksum2(S,(1526637529U));
  ssSetChecksum3(S,(3052122169U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c1_simlag(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_simlag(SimStruct *S)
{
  SFc1_simlagInstanceStruct *chartInstance;
  chartInstance = (SFc1_simlagInstanceStruct *)malloc(sizeof
    (SFc1_simlagInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc1_simlagInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c1_simlag;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c1_simlag;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c1_simlag;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c1_simlag;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c1_simlag;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c1_simlag;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c1_simlag;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c1_simlag;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c1_simlag;
  chartInstance->chartInfo.mdlStart = mdlStart_c1_simlag;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c1_simlag;
...
void c1_simlag_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_simlag(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_simlag(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_simlag(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_simlag_method_dispatcher.\n"
